...
function mouseOver() {
  bilde1.style.transform = `rotateX(0deg) translate(${-innerWidth / 2 +
    150}px, ${-innerHeight / 2 + 100}px)`;
  bilde2.style.transform = `rotateX(0deg) translate(0, ${-innerHeight / 2 +
    100}px)`;
  bilde3.style.transform = `rotateX(0deg) translate(${innerWidth / 2 -
    150}px, ${-innerHeight / 2 + 100}px)`;
  bilde4.style.transform = `rotateX(0deg) translate(${-innerWidth / 2 +
    150}px, 0`;
  bilde5.style.transform = `rotateX(0deg) translate(${innerWidth / 2 -
    150}px, 0`;
  bilde6.style.transform = `rotateX(0deg) translate(${-innerWidth / 2 +
    150}px, ${innerHeight / 2 - 100}px)`;
  bilde7.style.transform = `rotateX(0deg) translate(0, ${innerHeight / 2 -
    100}px)`;
  bilde8.style.transform = `rotateX(0deg) translate(${innerWidth / 2 -
    150}px, ${innerHeight / 2 - 100}px)`;
}
